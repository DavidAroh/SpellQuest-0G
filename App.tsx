...
const App: React.FC = () => {
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          >
            <Trophy size={14} /> On-Chain Leaderboard
          </button>
  ...
  return (
    <div className="w-full h-full relative">
      {mode === "SINGLE" && <SpellingAdventure onScoreChange={setLastScore} />}
      ...
      <div className="fixed top-4 right-4 z-[100] flex gap-2">
        <button
          className="bg-amber-500 hover:bg-amber-600 text-black px-4 py-2.5 rounded-full shadow-xl font-bold text-sm transition-all hover:scale-105 active:scale-95 border-2 border-amber-300/50 backdrop-blur-sm flex items-center gap-1.5"
          onClick={() => setShowBoard(true)}
